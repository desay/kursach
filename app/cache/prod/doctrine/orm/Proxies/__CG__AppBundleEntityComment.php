...
class Comment extends \AppBundle\Entity\Comment implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Comment' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Comment' . "\0" . 'text', '' . "\0" . 'AppBundle\\Entity\\Comment' . "\0" . 'ownerId', '' . "\0" . 'AppBundle\\Entity\\Comment' . "\0" . 'dateCreate', '' . "\0" . 'AppBundle\\Entity\\Comment' . "\0" . 'dateUpdate', '' . "\0" . 'AppBundle\\Entity\\Comment' . "\0" . 'news');
        }
