...
class News extends \AppBundle\Entity\News implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\News' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\News' . "\0" . 'title', '' . "\0" . 'AppBundle\\Entity\\News' . "\0" . 'description', '' . "\0" . 'AppBundle\\Entity\\News' . "\0" . 'dateCreate', '' . "\0" . 'AppBundle\\Entity\\News' . "\0" . 'dateUpdate', '' . "\0" . 'AppBundle\\Entity\\News' . "\0" . 'views', '' . "\0" . 'AppBundle\\Entity\\News' . "\0" . 'image', '' . "\0" . 'AppBundle\\Entity\\News' . "\0" . 'comments', '' . "\0" . 'AppBundle\\Entity\\News' . "\0" . 'status');
        }
