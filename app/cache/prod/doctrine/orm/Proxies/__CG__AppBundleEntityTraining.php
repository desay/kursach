 ...
 */
class Training extends \AppBundle\Entity\Training implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Training' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Training' . "\0" . 'title', '' . "\0" . 'AppBundle\\Entity\\Training' . "\0" . 'description', '' . "\0" . 'AppBundle\\Entity\\Training' . "\0" . 'dateCreate', '' . "\0" . 'AppBundle\\Entity\\Training' . "\0" . 'dateUpdate', '' . "\0" . 'AppBundle\\Entity\\Training' . "\0" . 'price', '' . "\0" . 'AppBundle\\Entity\\Training' . "\0" . 'image');
        }
